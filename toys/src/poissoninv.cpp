...
#ifndef POISSONINV_CPP
#define POISSONINV_CPP

#include "poissoninv.hpp"

double PoissonInverse::poissinv(double U, double Lam) { return poissinv_core(U, 1.0 - U, Lam); }

double PoissonInverse::poisscinv(double V, double Lam) { return poissinv_core(1.0 - V, V, Lam); }

inline double PoissonInverse::poissinv_core(double U, double V, double Lam) {
    int    i;
...
double PoissonInverse::poissinv_v(double U, double Lam) {
    int    i;
...
double PoissonInverse::normcdfinv_as241(double p) {
