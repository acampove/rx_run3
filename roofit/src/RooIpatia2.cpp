#ifndef ROOIPATIA2_CPP
#define ROOIPATIA2_CPP
/*****************************************************************************
 * Project: RooFit                                                           *
 *                                                                           *
...
Double_t RooIpatia2__low_x_BK(Double_t nu, Double_t x) { return TMath::Gamma(nu) * TMath::Power(2., nu - 1.) * TMath::Power(x, -nu); }

Double_t RooIpatia2__low_x_LnBK(Double_t nu, Double_t x) { return TMath::Log(TMath::Gamma(nu)) + (nu - 1.) * RooIpatia2__log_de_2 - nu * TMath::Log(x); }
...
ClassImp(RooIpatia2)
    ...
    RooIpatia2::RooIpatia2(const char * name, const char * title, RooAbsReal & _x, RooAbsReal & _l, RooAbsReal & _zeta, RooAbsReal & _fb, RooAbsReal & _sigma, RooAbsReal & _mu, RooAbsReal & _a, RooAbsReal & _n, RooAbsReal & _a2, RooAbsReal & _n2)
