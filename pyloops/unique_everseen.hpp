...
namespace iter {
    ...
    template < typename Container > auto unique_everseen(Container && container) -> impl::Filtered< std::function< bool(impl::iterator_deref< Container >) >, Container > {
    ...
    template < typename T > auto unique_everseen(std::initializer_list< T > il) -> impl::Filtered< std::function< bool(T) >, std::initializer_list< T > > {
