...
class RooDalitzAmplitude : public RooAbsPdf {
  public:
    RooDalitzAmplitude()
        ...
        , CG43(4, 3)
        , CG63(6, 3){};
    RooDalitzAmplitude(const char * name, const char * title, RooArgList & values, TList *, TList *, const TString MCdata, RooDataSet &, bool isPP = true, bool isCach = true);
    ...
    bool     BW_AMP(double m_r, double gamma_r, double mpp, int LR, double & ampl_r, double & ampl_i) const;
    bool     BW_AMPZ(double m_r, double gamma_r, double mpp, int LR, double & ampl_r, double & ampl_i) const;
    Double_t getp(double, double, double) const;
    void     filldlz(Jpsihh_dlz & dlz, Double_t xmkp, Double_t, Double_t xcostheta1, Double_t xcostheta2, Double_t xphi1, Double_t xphi2, Double_t, Double_t, Double_t, Double_t, Double_t, Double_t, Double_t, Double_t, Double_t xjpsip = 0.0, Double_t w = 1.0) const;
    ...
    virtual RooAbsReal * createSUM(RooAbsData & data, const RooCmdArg & arg1 = RooCmdArg::none(), const RooCmdArg & arg2 = RooCmdArg::none(), const RooCmdArg & arg3 = RooCmdArg::none(), const RooCmdArg & arg4 = RooCmdArg::none(), const RooCmdArg & arg5 = RooCmdArg::none(), const RooCmdArg & arg6 = RooCmdArg::none(), const RooCmdArg & arg7 = RooCmdArg::none(), const RooCmdArg & arg8 = RooCmdArg::none());
