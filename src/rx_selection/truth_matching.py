...
def get_truth(event_type : Union[int,str]) -> str:
    ...
    if     event_type.startswith('DATA_'):
        ...
        # B+ -> pi+ee
        cut= 'TMath::Abs(B_TRUEID) == 521 && TMath::Abs(L1_TRUEID) == 11 && TMath::Abs(L2_TRUEID) == 11 && TMath::Abs(L1_MC_MOTHER_ID) == 521 && TMath::Abs(L2_MC_MOTHER_ID) == 521 && TMath::Abs(H_TRUEID) == 221 && TMath::Abs(H_MC_MOTHER_ID) == 521'
